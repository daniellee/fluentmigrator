...
namespace FluentMigrator.Runner
{
	public class MigrationRunner : IMigrationRunner
	{
        ...
        readonly IAnnouncer _announcer;
        readonly IStopWatch _stopWatch;
        bool _alreadyOutputPreviewOnlyModeWarning;
        ...
        void ApplyMigrationUp(long version)
		{
		...
		private void ApplyMigrationDown(long version)
		{
			...
			{
                var msg = string.Format("VersionInfo references version {0} but no Migrator was found attributed with that version.", version);
